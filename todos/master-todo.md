# Master TODO — qwen-asr SDD

## Registered Specs

### Spec 001: Core Transcription Pipeline
- **Status**: Specified (implementation pre-existing)
- **Spec**: specs/001-core-transcription/spec.md
- **GATE 1**: PASS
...
- **Audit**: specs/002-local-api-service/audit-report.md (PASS)
- **GATE 1**: PASS
- **GATE 2**: SKIP (complexity 0-2)
- **GATE 3**: PASS
